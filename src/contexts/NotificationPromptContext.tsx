            ...
            <div className="p-6">
              ...
              <div className="space-y-2.5">
                <button
                  ...
                  disabled={requesting}
                  className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold text-sm rounded-xl transition-colors disabled:opacity-50 cursor-pointer"
                >
