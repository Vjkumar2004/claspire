...
export default function Home() {
  return (
    <div className="landing-page min-h-screen bg-[#FFF8EE] font-[family-name:var(--font-inter)] [&_h1]:font-[family-name:var(--font-inter)] [&_h2]:font-[family-name:var(--font-inter)] [&_h3]:font-[family-name:var(--font-inter)]">
      <Hero />
      <Mission />
      <CollegeBar />
      <Features />
