    ...
    <div className="bg-white text-black min-h-screen">
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">2. How We Use Your Information</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">3. Data Storage</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">4. Cookies</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">5. Third Party Services</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">6. Contact</h2>
            <p className="text-gray-600 leading-relaxed">
