  ...
  return (
    <div className="bg-surface dark:bg-[#1D2226] text-gray-900 dark:text-white min-h-screen">
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-16">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-gray-500 dark:text-[#B0B7BE] hover:text-[#0A66C2] font-medium transition-colors mb-8"
        >
        ...
        {/* Vision Section */}
        <div className="mb-16">
          <div className="bg-[#EAF4FF] rounded-3xl p-10 border border-[#0A66C2]/20 text-center">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-surface dark:bg-[#283036] p-8 rounded-2xl border border-surface dark:border-[#38434F] shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-[#EAF4FF] text-[#0A66C2] rounded-full flex items-center justify-center text-2xl mb-5">
                🎯
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-app dark:bg-[#1D2226] rounded-2xl p-6 border border-surface dark:border-[#38434F]">
              <h3 className="font-bold text-lg mb-3 text-[#0A66C2]">Authenticity</h3>
            ...
            <div className="bg-app dark:bg-[#1D2226] rounded-2xl p-6 border border-surface dark:border-[#38434F]">
              <h3 className="font-bold text-lg mb-3 text-[#0A66C2]">Accessibility</h3>
              <p className="text-gray-600 dark:text-[#B0B7BE] text-sm leading-relaxed">
                Quality guidance shouldn't be a luxury. We're making it accessible to every student.
              </p>
            </div>
            <div className="bg-app dark:bg-[#1D2226] rounded-2xl p-6 border border-surface dark:border-[#38434F]">
              <h3 className="font-bold text-lg mb-3 text-[#0A66C2]">Community</h3>
              <p className="text-gray-600 dark:text-[#B0B7BE] text-sm leading-relaxed">
                Building supportive ecosystems where students help each other grow.
              </p>
            </div>
            <div className="bg-app dark:bg-[#1D2226] rounded-2xl p-6 border border-surface dark:border-[#38434F]">
              <h3 className="font-bold text-lg mb-3 text-[#0A66C2]">Impact</h3>
              <p className="text-gray-600 dark:text-[#B0B7BE] text-sm leading-relaxed">
