  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-16">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-gray-500 hover:text-purple-600 font-medium transition-colors mb-8"
        >
        ...
        {/* Mission Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">Bridging the Gap Between Students & College Seniors in India</h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">Why Students Use This College Senior Mentorship Platform</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Verified Alumni Network</h3>
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Direct Referrals</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        {/* Values Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">How Our Campus Peer Network Works</h2>
          <div className="grid md:grid-cols-2 gap-6">
