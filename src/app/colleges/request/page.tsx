...
export default function CollegeRequestPage() {
      ...
      <div className="min-h-screen bg-[#F5F4FF] font-plus-jakarta-sans">
        <div className="flex items-center justify-center min-h-[80vh] px-4">
           <motion.div 
             ...
             className="max-w-xl w-full bg-surface dark:bg-[#283036] rounded-[40px] shadow-2xl p-10 md:p-16 text-center border border-[#EEEBFF] dark:border-[#38434F]"
           >
              ...
              >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-surface/10 rounded-full blur-2xl -mr-16 -mt-16" />
  ...
  return (
    <div className="min-h-screen bg-[#F5F4FF] font-plus-jakarta-sans pb-20">
      ...
      {/* ── Hero ── */}
      <div className="relative pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#0F172A]">
         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0A66C2]/10 rounded-full blur-[100px] -mr-64 -mt-64" />
         ...
         <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
               <div className="inline-flex items-center gap-2 bg-surface/5 border border-white/10 rounded-full px-4 py-2 text-[10px] font-black text-[#0A66C2] tracking-[0.2em] uppercase mb-6">
                  <Sparkles size={14} /> Can&apos;t find your college?
               </div>
               <h1 className="text-4xl md:text-6xl font-black text-white mb-6 font-instrument-serif leading-tight">Request Your <span className="text-[#0A66C2]">College Hub</span></h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <motion.div 
            ...
            className="bg-surface dark:bg-[#283036] rounded-[40px] border border-[#EEEBFF] dark:border-[#38434F] shadow-2xl p-8 md:p-12"
        >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <input 
                            ...
                            className="w-full bg-app dark:bg-[#222B31] border border-surface dark:border-[#38434F] rounded-2xl px-5 py-4 text-sm text-[#0F172A] dark:text-white outline-none focus:bg-surface dark:focus:bg-[#283036] focus:border-[#0A66C2] focus:shadow-[0_0_0_4px_rgba(124,58,237,0.05)] transition-all font-bold dark:placeholder:text-[#8B949E]"
                        />
                        </div>
                        <div>
                        ...
                        <select 
                            ...
                            className="w-full bg-app dark:bg-[#222B31] border border-surface dark:border-[#38434F] rounded-2xl px-5 py-4 text-sm text-[#0F172A] dark:text-white outline-none focus:bg-surface dark:focus:bg-[#283036] focus:border-[#0A66C2] focus:shadow-[0_0_0_4px_rgba(124,58,237,0.05)] transition-all appearance-none cursor-pointer font-bold dark:placeholder:text-[#8B949E]"
                        >
                        ...
                        <textarea 
                            ...
                            className="w-full bg-app dark:bg-[#222B31] border border-surface dark:border-[#38434F] rounded-2xl px-5 py-4 text-sm text-[#0F172A] dark:text-white outline-none focus:bg-surface dark:focus:bg-[#283036] focus:border-[#0A66C2] transition-all h-24 resize-none font-medium dark:placeholder:text-[#8B949E]"
                        />
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full bg-[#0A66C2] text-white font-black py-5 rounded-3xl shadow-xl shadow-[#0A66C2]/20/50 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                    >
            ...
            <div className="lg:col-span-4">
                <div className="sticky top-24 space-y-8">
                    {/* Logo Section */}
                    <div className="bg-app dark:bg-[#1D2226] rounded-[32px] p-8 border border-surface dark:border-[#38434F] text-center">
                        ...
                        <div className="relative group mx-auto mb-8">
                            <div className="w-32 h-32 md:w-36 md:h-36 bg-surface dark:bg-[#283036] rounded-[32px] border-2 border-dashed border-surface dark:border-[#38434F] flex items-center justify-center overflow-hidden transition-all group-hover:border-[#0A66C2]">
                                {logoPreview ? (
                                    <img src={logoPreview} alt="Logo Preview" className="w-full h-full object-contain p-4" />
                                ) : (
                                    <div className="flex flex-col items-center gap-2 text-gray-300 dark:text-[#B0B7BE] group-hover:text-[#0A66C2]">
                                        <Upload size={32} />
                            ...
                            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-[#0A66C2] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#0A66C2]/20 pointer-events-none group-hover:scale-110 transition-transform">
                                <Plus size={20} />
                            </div>
                        </div>
                    ...
                    {/* Recent Requests */}
                    <div className="bg-surface dark:bg-[#283036] rounded-3xl border border-surface dark:border-[#38434F] p-6">
                       ...
                       <div className="space-y-3">
                          {dataLoading ? (
                             [1,2].map(i => <div key={i} className="h-12 bg-app dark:bg-[#1D2226] rounded-2xl animate-pulse" />)
                          ) : requests.length > 0 ? (
                             requests.slice(0, 3).map(req => (
                                <div key={req.id} className="flex items-center justify-between gap-3 p-3 bg-app dark:bg-[#1D2226] rounded-2xl border border-transparent hover:border-orange-100 transition-colors">
                    ...
                    <div className="bg-[#0F172A] rounded-3xl p-6 text-white relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-[#0A66C2]/20 rounded-full blur-2xl -mr-12 -mt-12" />
                        ...
                        <div className="flex flex-wrap gap-2">
                           {existingColleges.slice(0, 6).map(col => (
                              <span key={col.id} className="text-[10px] font-bold bg-surface/10 px-2.5 py-1 rounded-lg border border-white/5">
                                 {col.short_name}
                              </span>
                           ))}
                        </div>
