  ...
  return (
    <div className="bg-surface dark:bg-[#1D2226] text-black dark:text-white min-h-screen">
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-gray-600 dark:text-[#B0B7BE] hover:text-black dark:text-white dark:hover:text-white transition-colors mb-8"
        >
        ...
        <div className="bg-app dark:bg-[#1D2226] border border-surface dark:border-[#38434F] rounded-xl p-8 text-center mb-12">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 border border-[#0A66C2] text-[#0A66C2] px-6 py-3 rounded-lg hover:bg-[#0A66C2] hover:text-white transition-colors font-medium"
          >
