...
function OnboardingPersonCard({
  ...
  return (
    ...
    >
      {/* Banner */}
      <div className="h-14 bg-gradient-to-br from-[#1E1B4B] via-[#312E81] to-[#4C1D95] relative flex items-center justify-center overflow-hidden">
...
function CommunityCard({
  ...
  return (
    ...
    >
      {recommended && (
        <div className="absolute top-2 right-2 z-20 flex items-center gap-1 bg-purple-600 text-white text-[9px] font-bold px-2 py-0.5 rounded-full shadow-lg">
        ...
        <button
          ...
          className={`w-full h-8 rounded-xl text-[11px] font-bold flex items-center justify-center gap-1 transition-all duration-200 ${
            joined
              ...
              : 'bg-purple-600 hover:bg-purple-700 text-white active:scale-95 shadow-sm shadow-purple-600/20'
          }`}
        >
  ...
  return (
    <div className="flex flex-col items-center text-center px-1">
        ...
        <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-xl shadow-purple-500/20 bg-white mx-auto">
          <img
            ...
            onError={(e) => {
              ...
              if (parent) {
                parent.className = 'w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-xl shadow-purple-500/20 mx-auto'
      ...
      <div className="w-full space-y-2.5 mb-7">
        {benefits.map(({ icon: Icon, title, desc }, i) => (
          <motion.div
            ...
            className="flex items-start gap-3.5 p-3.5 bg-white/60 dark:bg-[#1D2226]/60 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-[#2D3744] text-left cursor-default transition-colors group hover:border-purple-200 dark:hover:border-purple-800/50"
          >
      ...
      >
        ...
        <button
          onClick={onNext}
          className="w-full py-3.5 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-bold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-purple-600/25 flex items-center justify-center gap-2 hover:gap-3"
        >
          Build My Profile
          <ArrowRight size={15} />
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={80}
              className="w-full h-11 px-4 rounded-xl border border-gray-200 dark:border-[#38434F] bg-gray-50 dark:bg-[#1D2226] text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-sm"
            />
            <div className="flex flex-wrap gap-1.5 mt-2">
              {examples.map((ex) => (
                <button
                  ...
                  className="px-2.5 py-0.5 text-[10px] font-semibold rounded-full bg-gray-100 dark:bg-[#283036] text-gray-600 dark:text-gray-400 hover:bg-purple-100 hover:text-purple-700 dark:hover:bg-purple-900/30 dark:hover:text-purple-400 transition-colors"
                >
                  {ex}
                </button>
              ))}
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-[#38434F] bg-gray-50 dark:bg-[#1D2226] text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all resize-none text-sm"
            />
          </div>
        </div>
        ...
        <div className="hidden lg:block">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-[#2D3744] bg-white dark:bg-[#1D2226] shadow-sm overflow-hidden">
            <div className="h-14 bg-gradient-to-br from-purple-600 to-violet-500" />
...
function SuccessScreen({
  ...
  return (
    ...
    >
      ...
      <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-xl shadow-purple-500/25 bg-white mb-5 mx-auto">
        <img
          ...
          onError={(e) => {
            ...
            const parent = t.parentElement
            if (parent) {
              parent.className = 'w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-xl shadow-purple-500/25 mb-5 mx-auto'
              parent.innerHTML = '<span class="text-white font-extrabold text-2xl">C</span>'
            }
          }}
        />
        ...
        <div className="space-y-2.5">
          {achievements.map(({ label, done, count }) => (
            <div key={label} className="flex items-center gap-3">
              ...
              {count && <span className="text-[10px] font-bold text-purple-600 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 px-2 py-0.5 rounded-full">{count}</span>}
      ...
      <button
        onClick={onEnter}
        className="w-full py-4 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-bold text-base rounded-2xl transition-all duration-200 shadow-xl shadow-purple-600/30 flex items-center justify-center gap-2 hover:gap-3"
      >
        Enter Claspire
        <ArrowRight size={18} />
      </button>
          ...
          <div className="w-6 h-6 rounded-lg overflow-hidden bg-white shadow-sm">
            <img
              ...
              onError={(e) => {
                ...
                if (p) {
                  p.className = 'w-6 h-6 rounded-lg bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-sm'
...
function OnboardingPageContent() {
  ...
  const fireConfetti = useCallback(async () => {
    ...
    confetti({
      ...
      spread: 90,
      origin: { y: 0.55 },
      colors: ['#7C3AED', '#A855F7', '#C4B5FD', '#6D28D9', '#DDD6FE'],
    })
    setTimeout(() => {
      confetti({ particleCount: 50, angle: 60, spread: 70, origin: { x: 0, y: 0.6 }, colors: ['#7C3AED', '#A855F7'] })
      confetti({ particleCount: 50, angle: 120, spread: 70, origin: { x: 1, y: 0.6 }, colors: ['#7C3AED', '#A855F7'] })
    }, 280)
  }, [])
