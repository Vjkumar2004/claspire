...
export default function OnboardingLayout({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0E14] text-gray-900 dark:text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[500px] bg-[#F4A01C]/10 dark:bg-purple-600/20 rounded-full blur-[120px] pointer-events-none -z-10" />
