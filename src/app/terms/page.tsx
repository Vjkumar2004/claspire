    ...
    <div className="bg-white text-black min-h-screen">
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">2. Eligibility</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">3. User Conduct</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">4. Content Ownership</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-black font-semibold mb-2 text-xl">5. Account Termination</h2>
            <p className="text-gray-600 leading-relaxed">
