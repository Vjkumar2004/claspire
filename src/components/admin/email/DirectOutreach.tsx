  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <button
                  ...
                  className={`p-4 rounded-lg border text-left transition-all ${
                    form.templateType === opt.value
                      ? 'border-[#0A66C2] bg-[#EAF4FF] dark:bg-purple-900/20 ring-2 ring-[#0A66C2]/20'
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  className="flex h-10 w-full rounded-md border border-gray-300 dark:border-gray-700 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0A66C2]"
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1D2226] overflow-hidden shadow-sm">
          <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-[#0A66C2] dark:text-purple-400 hover:underline"
            >
      ...
      <div className="space-y-6">
        ...
        {/* Actions */}
        <div className="rounded-xl border border-[#0A66C2]/20 dark:border-purple-900/50 bg-white dark:bg-[#1D2226] overflow-hidden shadow-sm">
          <div className="p-6 bg-[#EAF4FF]/50 dark:bg-purple-900/10 border-b border-[#0A66C2]/20 dark:border-purple-900/50">
            <h2 className="text-xl font-semibold text-[#004182] dark:text-purple-400">Send</h2>
          </div>
          <div className="p-6 space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  className="flex h-10 w-full rounded-md border border-gray-300 dark:border-gray-700 bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0A66C2]"
                  type="email"
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                className="flex-1 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 bg-[#0A66C2] text-white hover:bg-[#004182] h-10 px-4 py-2"
