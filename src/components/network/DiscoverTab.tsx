      ...
      <div className="bg-surface dark:bg-[#283036] rounded-2xl border border-surface dark:border-[#38434F]/80 dark:border-[#38434F]/80 shadow-sm p-3 lg:p-4 mb-4 lg:mb-6 flex items-center gap-2 lg:gap-3 transition-all duration-300">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full h-10 lg:h-[52px] pl-9 lg:pl-11 pr-8 lg:pr-20 text-xs lg:text-sm border border-surface dark:border-[#38434F] rounded-xl bg-surface dark:bg-[#283036] text-gray-900 dark:text-white outline-none focus:border-[#0A66C2] focus:ring-[3px] focus:ring-[#0A66C2]/15 transition-all duration-200 font-medium placeholder:text-gray-400 dark:text-[#B0B7BE]"
          />
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-4 lg:mb-5">
            ...
            <button className="hidden lg:flex text-sm font-semibold text-[#0A66C2] hover:text-[#004182] items-center gap-1">
        ...
        <div className="text-center py-16 network-card">
          <div className="w-16 h-16 bg-[#EAF4FF] dark:bg-purple-900/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
