    ...
    return (
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="text-xs font-semibold text-gray-400 bg-gray-100 px-3 py-1 rounded-full">{items.length}</span>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 2xl:grid-cols-3 gap-3 lg:gap-5">
          {items.map((f) => (
            <PeopleCard
  ...
  if (following.length === 0) {
    return (
      <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
        ...
        <p className="text-sm text-gray-500">Follow people in the Discover tab to stay updated</p>
      </div>
    )
  }
    ...
    <div>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 text-sm border border-gray-200 rounded-xl bg-white text-gray-900 outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-50 transition-all font-medium"
        />
      </div>
      ...
      {searchQuery && filtered.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
          ...
          <h3 className="text-base font-bold text-gray-900 mb-2">No matching results</h3>
