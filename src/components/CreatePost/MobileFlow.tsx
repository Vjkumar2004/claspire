      ...
      <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-white/10 bg-white/80 dark:bg-[#0B0F19]/80 backdrop-blur-xl z-10">
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1 mt-1">
            <span className="h-1.5 w-6 rounded-full bg-[#0A66C2]"></span>
            <span className={`h-1.5 w-6 rounded-full ${step >= 2 ? 'bg-[#0A66C2]' : 'bg-slate-200 dark:bg-white/10'}`}></span>
            <span className={`h-1.5 w-6 rounded-full ${step >= 3 ? 'bg-[#0A66C2]' : 'bg-slate-200 dark:bg-white/10'}`}></span>
          </div>
        </div>
        ...
        {step === 1 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-2 bg-slate-900 dark:from-white dark:to-white/60 bg-clip-text text-transparent">What do you want to share?</h3>
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 ${
                      isSelected 
                        ? 'border-[#0A66C2] bg-[#EAF4FF] dark:bg-purple-500/10 shadow-[0_0_30px_rgba(139,92,246,0.15)] scale-[1.02]' 
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      <div className={`font-bold text-lg ${isSelected ? 'text-[#004182] dark:text-purple-300' : 'text-slate-900 dark:text-white'}`}>{t.label}</div>
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className="space-y-2">
              ...
              <input
                ...
                maxLength={120}
                className="w-full bg-slate-50 border border-slate-200 dark:bg-white/5 dark:border-white/10 rounded-2xl px-4 py-4 text-lg font-bold text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 outline-none focus:border-[#0A66C2]/50 transition-colors"
              />
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
              ...
              <div className="space-y-3 mt-6">
                ...
                <div className="p-4 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#0A66C2] flex items-center justify-center overflow-hidden">
                  ...
                  <button
                    ...
                    className="text-[#0A66C2] text-sm font-bold bg-[#0A66C2]/10 px-3 py-1.5 rounded-lg hover:bg-[#0A66C2]/20"
                  >
                    Switch
                  </button>
                </div>
            ...
            <div className="mt-8 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10">
              ...
              <div className="text-sm text-slate-500 dark:text-white/50 line-clamp-2 [&>blockquote]:border-l-4 [&>blockquote]:border-[#0A66C2] [&>blockquote]:pl-4 [&>blockquote]:text-slate-500 dark:[&>blockquote]:text-white/70 [&>ul]:list-disc [&>ul]:pl-5 [&>ol]:list-decimal [&>ol]:pl-5 [&>a]:text-cyan-500 dark:[&>a]:text-cyan-400 [&>a]:underline">
                {data.content ? (
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-xl border-t border-slate-200 dark:border-white/10 flex items-center justify-between z-20">
        ...
        {step < 3 ? (
          ...
          <button 
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#0A66C2] text-white rounded-xl font-bold shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] transition-all disabled:opacity-50"
          >
