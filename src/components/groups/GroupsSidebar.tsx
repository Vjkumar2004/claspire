  ...
  return (
    ...
    >
      <div className="relative flex-shrink-0">
        <div className="w-12 h-12 rounded-full bg-[#0A66C2] text-white flex items-center justify-center text-sm font-bold shadow-sm">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between gap-2 mt-0.5">
          ...
          {badge && (
            <span className="flex-shrink-0 min-w-[18px] h-[18px] rounded-full bg-[#0A66C2] text-white text-[10px] font-bold flex items-center justify-center px-1">
              {badge}
            </span>
          )}
        </div>
