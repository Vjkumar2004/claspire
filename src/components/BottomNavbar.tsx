          ...
          {navItems.map((item, index) => {
            ...
            if (isCenterItem(item)) {
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 bg-[#0A66C2] rounded-lg flex items-center justify-center shadow-md transition-transform group-hover:scale-110 active:scale-95">
            ...
            if (isRegularItem(item)) {
              ...
              return (
                ...
                >
                  <div className={`transition-all duration-200 flex flex-col items-center justify-center h-7 ${isActive ? 'text-[#0A66C2]' : 'text-gray-400 group-hover:text-gray-600 dark:text-[#6B7B8B] dark:group-hover:text-[#B0B7BE]'}`}>
                  ...
                  <span className={`text-[10px] mt-0.5 font-bold tracking-tight transition-colors duration-200 ${isActive ? 'text-[#0A66C2]' : 'text-gray-400 group-hover:text-gray-600 dark:text-[#6B7B8B] dark:group-hover:text-[#B0B7BE]'}`}>
                    {item.label}
                  </span>
                </Link>
              )
