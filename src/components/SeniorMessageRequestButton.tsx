    ...
    return (
      <>
        <button
          ...
          disabled={sending}
          className="bg-[#0A66C2] hover:bg-cyan-700 text-white rounded-xl px-4 py-2 text-sm font-medium transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <Users size={14} />
          Connect
        </button>
