        ...
        <div className="bg-surface dark:bg-[#283036] rounded-md border border-surface dark:border-[#38434F] overflow-hidden shadow-sm">
          ...
          <div className="p-1.5 space-y-0.5">
            {communities.slice(0, 4).map((c: any) => (
              ...
              >
                <div className="w-7 h-7 rounded bg-[#EAF4FF] border border-surface dark:border-[#38434F] flex items-center justify-center font-bold text-[#0A66C2] overflow-hidden text-[10px] flex-shrink-0">
                  {c.colleges?.logo_url ? (
          ...
          <button
            ...
            className="w-full py-2 bg-[#EAF4FF] hover:bg-[#EAF4FF] text-[#0A66C2] text-[11px] font-bold text-center border-t border-surface dark:border-[#38434F] transition-colors cursor-pointer block"
          >
            Explore Campuses ↗
          </button>
        </div>
